...
export const skills: Skill[] = [
  ...
  // State Management
  { name: 'BLOC', level: 90, category: 'design', icon: '🧩' },
  { name: 'Riverpod', level: 85, category: 'design', icon: '🌊' },
  { name: 'Cubit', level: 88, category: 'design', icon: '📦' }
]
...
export const contactInfo: ContactInfo = {
  ...
  twitter: 'https://twitter.com/rajushah0'
}
