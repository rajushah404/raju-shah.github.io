    ...
    <section id="about" className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden border-t-2 border-green-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-cyan-300 max-w-3xl mx-auto font-mono">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              <div className="w-full h-96 bg-black border-2 border-cyan-400 p-4 font-mono">
            ...
            {/* 90s Glitch Effect */}
            <div className="absolute -top-2 -right-2 w-4 h-4 bg-cyan-400 animate-pulse"></div>
            <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-yellow-400 animate-pulse"></div>
          </div>

          {/* Right Column - Content */}
          <div className="space-y-8">
            <div className="bg-black border-2 border-cyan-400 p-4 font-mono text-cyan-300">
              <div className="text-cyan-400 text-sm mb-2">&gt; BIO.TXT</div>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-cyan-400 font-mono">WHAT_I_DO.DAT</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center space-x-3 p-4 bg-black border-2 border-cyan-400">
                  <div className="w-10 h-10 bg-cyan-400 flex items-center justify-center">
                    <span className="text-black font-bold">📱</span>
                  </div>
                  <div>
                    <h4 className="text-cyan-400 font-medium font-mono">FLUTTER.EXE</h4>
                    <p className="text-cyan-300 text-sm font-mono">[CROSS-PLATFORM APPS]</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-3 p-4 bg-black border-2 border-yellow-400">
                  <div className="w-10 h-10 bg-yellow-400 flex items-center justify-center">
                    <span className="text-black font-bold">🎯</span>
                  </div>
                  <div>
                    <h4 className="text-yellow-400 font-medium font-mono">DART.DAT</h4>
                    <p className="text-yellow-300 text-sm font-mono">[PROGRAMMING LANGUAGE]</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-3 p-4 bg-black border-2 border-green-400">
                  <div className="w-10 h-10 bg-green-400 flex items-center justify-center">
                    <span className="text-black font-bold">🔥</span>
                  </div>
                  <div>
                    <h4 className="text-green-400 font-medium font-mono">FIREBASE.EXE</h4>
                    <p className="text-green-300 text-sm font-mono">[BACKEND SERVICES]</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-3 p-4 bg-black border-2 border-purple-400">
                  <div className="w-10 h-10 bg-purple-400 flex items-center justify-center">
                    <span className="text-black font-bold">🧩</span>
                  </div>
                  <div>
                    <h4 className="text-purple-400 font-medium font-mono">BLOC.DAT</h4>
                    <p className="text-purple-300 text-sm font-mono">[STATE MANAGEMENT]</p>
                  </div>
                </div>
              </div>
            </div>
